...
@section('content')
    ...
    @if ($user->role)
        ...
        <div class="container p-7">
            <h2 class="pb-3 text-center text-abu-300">Update Harga Komoditas Pasar Hari ini</h2>
            @if (isset($data_api['data1']['komoditas']) && isset($data_api['data1']['harga']) && isset($data_api['data2']['harga']))
                @for ($i = 0; $i < count($data_api['data1']['komoditas']); $i++)
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                @if ($data_api['data1']['harga'][$i] > $data_api['data2']['harga'][$i])
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="currentColor" class="bi bi-caret-up-square-fill" viewBox="0 0 16 16">
                                        <path
                                ...
                                @else
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="currentColor" class="bi bi-caret-down-square-fill" viewBox="0 0 16 16">
                                        <path
