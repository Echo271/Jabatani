        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                <div class="flex items-center">
                    ...
                    {{-- ! Menu saat menekan profile --}}
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-hijau-primary dark:divide-gray-600"
                        id="dropdown-user">
